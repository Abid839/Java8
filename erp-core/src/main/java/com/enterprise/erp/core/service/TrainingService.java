...
import com.enterprise.erp.domain.repository.TrainingRepository;
...
public class TrainingService {
    ...
    public Training processBusinessLogic1(Training entity) {
    ...
    public Training processBusinessLogic2(Training entity) {
    ...
    public Training processBusinessLogic3(Training entity) {
    ...
    public Training processBusinessLogic4(Training entity) {
    ...
    public Training processBusinessLogic5(Training entity) {
    ...
    public Training processBusinessLogic6(Training entity) {
    ...
    public Training processBusinessLogic7(Training entity) {
    ...
    public Training processBusinessLogic8(Training entity) {
    ...
    public Training processBusinessLogic9(Training entity) {
    ...
    public Training processBusinessLogic10(Training entity) {
