...
import com.enterprise.erp.domain.repository.AuditRepository;
...
public class AuditService {
    ...
    public Audit create(Audit entity) {
    ...
    public Audit processBusinessLogic1(Audit entity) {
    ...
    public Audit processBusinessLogic2(Audit entity) {
    ...
    public Audit processBusinessLogic3(Audit entity) {
    ...
    public Audit processBusinessLogic4(Audit entity) {
    ...
    public Audit processBusinessLogic5(Audit entity) {
    ...
    public Audit processBusinessLogic6(Audit entity) {
    ...
    public Audit processBusinessLogic7(Audit entity) {
    ...
    public Audit processBusinessLogic8(Audit entity) {
    ...
    public Audit processBusinessLogic9(Audit entity) {
    ...
    public Audit processBusinessLogic10(Audit entity) {
