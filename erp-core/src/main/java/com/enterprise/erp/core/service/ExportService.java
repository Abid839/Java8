...
import com.enterprise.erp.domain.repository.ExportRepository;
...
public class ExportService {
    ...
    public Export processBusinessLogic1(Export entity) {
    ...
    public Export processBusinessLogic2(Export entity) {
    ...
    public Export processBusinessLogic3(Export entity) {
    ...
    public Export processBusinessLogic4(Export entity) {
    ...
    public Export processBusinessLogic5(Export entity) {
    ...
    public Export processBusinessLogic6(Export entity) {
    ...
    public Export processBusinessLogic7(Export entity) {
    ...
    public Export processBusinessLogic8(Export entity) {
    ...
    public Export processBusinessLogic9(Export entity) {
    ...
    public Export processBusinessLogic10(Export entity) {
