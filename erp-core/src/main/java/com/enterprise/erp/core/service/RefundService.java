...
import com.enterprise.erp.domain.repository.RefundRepository;
...
public class RefundService {
    ...
    public Refund processBusinessLogic1(Refund entity) {
    ...
    public Refund processBusinessLogic2(Refund entity) {
    ...
    public Refund processBusinessLogic3(Refund entity) {
    ...
    public Refund processBusinessLogic4(Refund entity) {
    ...
    public Refund processBusinessLogic5(Refund entity) {
    ...
    public Refund processBusinessLogic6(Refund entity) {
    ...
    public Refund processBusinessLogic7(Refund entity) {
    ...
    public Refund processBusinessLogic8(Refund entity) {
    ...
    public Refund processBusinessLogic9(Refund entity) {
    ...
    public Refund processBusinessLogic10(Refund entity) {
