...
import com.enterprise.erp.domain.repository.TaxRepository;
...
public class TaxService {
    ...
    public Tax processBusinessLogic1(Tax entity) {
    ...
    public Tax processBusinessLogic2(Tax entity) {
    ...
    public Tax processBusinessLogic3(Tax entity) {
    ...
    public Tax processBusinessLogic4(Tax entity) {
    ...
    public Tax processBusinessLogic5(Tax entity) {
    ...
    public Tax processBusinessLogic6(Tax entity) {
    ...
    public Tax processBusinessLogic7(Tax entity) {
    ...
    public Tax processBusinessLogic8(Tax entity) {
    ...
    public Tax processBusinessLogic9(Tax entity) {
    ...
    public Tax processBusinessLogic10(Tax entity) {
