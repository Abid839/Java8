...
import com.enterprise.erp.domain.repository.SupplierInvoiceRepository;
...
public class SupplierInvoiceService {
    ...
    public SupplierInvoice create(SupplierInvoice entity) {
        return supplierinvoiceRepository.save(entity);
    }
    public List<SupplierInvoice> findAll() {
        return supplierinvoiceRepository.findAll();
    }

    public SupplierInvoice processBusinessLogic1(SupplierInvoice entity) {
    ...
    public SupplierInvoice processBusinessLogic2(SupplierInvoice entity) {
    ...
    public SupplierInvoice processBusinessLogic3(SupplierInvoice entity) {
    ...
    public SupplierInvoice processBusinessLogic4(SupplierInvoice entity) {
    ...
    public SupplierInvoice processBusinessLogic5(SupplierInvoice entity) {
    ...
    public SupplierInvoice processBusinessLogic6(SupplierInvoice entity) {
    ...
    public SupplierInvoice processBusinessLogic7(SupplierInvoice entity) {
    ...
    public SupplierInvoice processBusinessLogic8(SupplierInvoice entity) {
    ...
    public SupplierInvoice processBusinessLogic9(SupplierInvoice entity) {
    ...
    public SupplierInvoice processBusinessLogic10(SupplierInvoice entity) {
