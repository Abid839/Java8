...
import com.enterprise.erp.domain.repository.LegalRepository;
...
public class LegalService {
    ...
    public Legal create(Legal entity) {
        return legalRepository.save(entity);
    }

    public List<Legal> findAll() {
        return legalRepository.findAll();
    }

    public Legal processBusinessLogic1(Legal entity) {
    ...
    public Legal processBusinessLogic2(Legal entity) {
    ...
    public Legal processBusinessLogic3(Legal entity) {
    ...
    public Legal processBusinessLogic4(Legal entity) {
    ...
    public Legal processBusinessLogic5(Legal entity) {
    ...
    public Legal processBusinessLogic6(Legal entity) {
    ...
    public Legal processBusinessLogic7(Legal entity) {
    ...
    public Legal processBusinessLogic8(Legal entity) {
    ...
    public Legal processBusinessLogic9(Legal entity) {
    ...
    public Legal processBusinessLogic10(Legal entity) {
