...
import com.enterprise.erp.domain.repository.ProcurementRepository;
...
public class ProcurementService {
    ...
    public Procurement create(Procurement entity) {
        return procurementRepository.save(entity);
    }
    ...
    public Procurement processBusinessLogic1(Procurement entity) {
    ...
    public Procurement processBusinessLogic2(Procurement entity) {
    ...
    public Procurement processBusinessLogic3(Procurement entity) {
    ...
    public Procurement processBusinessLogic4(Procurement entity) {
    ...
    public Procurement processBusinessLogic5(Procurement entity) {
    ...
    public Procurement processBusinessLogic6(Procurement entity) {
    ...
    public Procurement processBusinessLogic7(Procurement entity) {
    ...
    public Procurement processBusinessLogic8(Procurement entity) {
    ...
    public Procurement processBusinessLogic9(Procurement entity) {
    ...
    public Procurement processBusinessLogic10(Procurement entity) {
