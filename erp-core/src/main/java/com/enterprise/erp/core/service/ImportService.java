...
import com.enterprise.erp.domain.repository.ImportRepository;
...
public class ImportService {
    ...
    public Import processBusinessLogic1(Import entity) {
    ...
    public Import processBusinessLogic2(Import entity) {
    ...
    public Import processBusinessLogic3(Import entity) {
    ...
    public Import processBusinessLogic4(Import entity) {
    ...
    public Import processBusinessLogic5(Import entity) {
    ...
    public Import processBusinessLogic6(Import entity) {
    ...
    public Import processBusinessLogic7(Import entity) {
    ...
    public Import processBusinessLogic8(Import entity) {
    ...
    public Import processBusinessLogic9(Import entity) {
    ...
    public Import processBusinessLogic10(Import entity) {
