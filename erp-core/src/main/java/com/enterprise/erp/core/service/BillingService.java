...
import com.enterprise.erp.domain.repository.BillingRepository;
...
public class BillingService {
    ...
    public Billing processBusinessLogic1(Billing entity) {
    ...
    public Billing processBusinessLogic2(Billing entity) {
    ...
    public Billing processBusinessLogic3(Billing entity) {
    ...
    public Billing processBusinessLogic4(Billing entity) {
    ...
    public Billing processBusinessLogic5(Billing entity) {
    ...
    public Billing processBusinessLogic6(Billing entity) {
    ...
    public Billing processBusinessLogic7(Billing entity) {
    ...
    public Billing processBusinessLogic8(Billing entity) {
    ...
    public Billing processBusinessLogic9(Billing entity) {
    ...
    public Billing processBusinessLogic10(Billing entity) {
