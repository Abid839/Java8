...
import com.enterprise.erp.domain.repository.ReturnRepository;
...
public class ReturnService {
    ...
    public Return create(Return entity) {
    ...
    public Return processBusinessLogic1(Return entity) {
    ...
    public Return processBusinessLogic2(Return entity) {
    ...
    public Return processBusinessLogic3(Return entity) {
    ...
    public Return processBusinessLogic4(Return entity) {
    ...
    public Return processBusinessLogic5(Return entity) {
    ...
    public Return processBusinessLogic6(Return entity) {
    ...
    public Return processBusinessLogic7(Return entity) {
    ...
    public Return processBusinessLogic8(Return entity) {
    ...
    public Return processBusinessLogic9(Return entity) {
    ...
    public Return processBusinessLogic10(Return entity) {
