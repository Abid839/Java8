...
import com.enterprise.erp.domain.repository.LeaveRepository;
...
public class LeaveService {
    ...
    public Leave create(Leave entity) {
    ...
    public Leave processBusinessLogic1(Leave entity) {
    ...
    public Leave processBusinessLogic2(Leave entity) {
    ...
    public Leave processBusinessLogic3(Leave entity) {
    ...
    public Leave processBusinessLogic4(Leave entity) {
    ...
    public Leave processBusinessLogic5(Leave entity) {
    ...
    public Leave processBusinessLogic6(Leave entity) {
    ...
    public Leave processBusinessLogic7(Leave entity) {
    ...
    public Leave processBusinessLogic8(Leave entity) {
    ...
    public Leave processBusinessLogic9(Leave entity) {
    ...
    public Leave processBusinessLogic10(Leave entity) {
